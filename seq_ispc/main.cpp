...
int main() {
    ...
    for(int i = 0; i < magnitude; i ++) {
     ...
     int* in_scan = new int[NUM_TUPPLES];
     int* in_index = new int[NUM_TUPPLES];
     int* ispc_result = new int[NUM_TUPPLES];
    ...
    select_ispc_withtasks(NUM_TUPPLES, relation, ispc_result, in_scan, in_index);
    ...
    validate(NUM_TUPPLES, sequential_result, ispc_result);
